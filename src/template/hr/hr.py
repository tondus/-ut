...
def get_pic(data,config):
    ...
    if data[col_asynchronus]:
        if data[col_inbound] : 
            pic = root_images + r"\legacy\async_in_hr.png"
            ...
            pic = root_images + r"\legacy\async_out.png"
        ...
        if data[col_inbound] : 
            pic = root_images + r"\legacy\sync_in.png"
            ...
            pic = root_images + r"\legacy\sync_out.png"
